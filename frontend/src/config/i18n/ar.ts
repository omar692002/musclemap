...
export const ar: Translation = {
  ui: {
    ...
    authSignInSub: 'سجّل الدخول لمزامنة تمارينك وبرامجك وتقدمك.',
    authSignUpSub: 'انضم إلى MuscleMap لحفظ تمارينك وبرامجك وتقدمك.',
    ...
    authBackendNote: 'تسجيل الدخول بالبريد يتطلب خادم MuscleMap. استخدم Google في الوقت الحالي.',
    ...
    onboardingSkip: 'لاحقًا',
    editProfile: 'تعديل الملف',
    profileEditTitle: 'ملفّي',
    profileEditSubtitle: 'اطّلع على معلوماتك وحدّثها في أي وقت.',
    profileSave: 'حفظ',
    profileCancel: 'إلغاء',
    profileSaved: 'تم حفظ الملف.',
    profileSaveError: 'تعذّر حفظ الملف. حاول مرة أخرى.',
    authNetworkError: 'تعذّر الوصول إلى الخادم. تحقّق من اتصالك — قد يكون قيد التشغيل، أعد المحاولة بعد لحظات.',
    ...
    coachFieldMuscle: 'المجموعة (المجموعات) العضلية',
    coachMuscleRequiredHint: 'اختر مجموعة عضلية واحدة على الأقل.',
