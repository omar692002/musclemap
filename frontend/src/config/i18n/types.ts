...
export interface UiStrings {
  ...
  readonly authSignInTitle: string
  readonly authSignUpTitle: string
  readonly authSignInSub: string
  readonly authSignUpSub: string
  readonly emailLabel: string
  readonly passwordLabel: string
  readonly nameLabel: string
  readonly authSubmitSignIn: string
  readonly authSubmitSignUp: string
  readonly authSwitchToSignUp: string
  readonly authSwitchToSignIn: string
  readonly authDivider: string
  readonly authPasswordHint: string
  readonly authBackendNote: string
  readonly authError: string
  readonly authBusy: string
  // Onboarding (EM3).
