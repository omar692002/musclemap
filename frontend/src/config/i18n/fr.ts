...
export const fr: Translation = {
  ui: {
    ...
    authSignInSub: 'Connecte-toi pour synchroniser tes séances, programmes et progrès.',
    authSignUpSub: 'Rejoins MuscleMap pour sauvegarder tes séances, programmes et progrès.',
    emailLabel: 'E-mail',
    passwordLabel: 'Mot de passe',
    nameLabel: 'Nom',
    authSubmitSignIn: 'Se connecter',
    authSubmitSignUp: 'Créer le compte',
    authSwitchToSignUp: 'Nouveau ? Crée un compte',
    authSwitchToSignIn: 'Déjà un compte ? Connecte-toi',
    authDivider: 'ou',
    authPasswordHint: '8 caractères minimum',
    authBackendNote: "La connexion par e-mail nécessite le serveur MuscleMap. Pour l'instant, utilise Google.",
    authError: 'Une erreur est survenue. Vérifie tes informations et réessaie.',
    authBusy: 'Patiente…',
    ...
    profileEditTitle: 'Mon profil',
    profileEditSubtitle: 'Consulte et mets à jour tes informations à tout moment.',
    profileSave: 'Enregistrer',
    profileCancel: 'Annuler',
    profileSaved: 'Profil enregistré.',
    profileSaveError: "Impossible d'enregistrer le profil. Réessaie.",
    authNetworkError: "Serveur injoignable. Vérifie ta connexion — il est peut-être en train de démarrer, réessaie dans un instant.",
    ...
    coachFieldMuscle: 'Groupe(s) musculaire(s)',
    coachMuscleRequiredHint: 'Sélectionne au moins un groupe musculaire.',
